...
import { isValidDistrict, normalizeDistrict } from "./districts";
 ...
 */
export function getMunicipalities(district?: string): Municipality[] {
  if (district) {
 ...
 */
export function getDistrictByMunicipality(
  municipality: string
): District | undefined {
 ...
 */
export function isValidMunicipality(name: string, district?: string): boolean {
